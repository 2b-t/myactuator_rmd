...
#ifndef MYACTUATOR_RMD_DRIVER__PROTOCOL__RESPONSES__SET_VELOCITY_RESPONSE
#define MYACTUATOR_RMD_DRIVER__PROTOCOL__RESPONSES__SET_VELOCITY_RESPONSE
#pragma once
  ...
  */
  ...
  : FeedbackResponse{data} {
    if (data[0] != CommandType::SPEED_CLOSED_LOOP_CONTROL) {
      throw ProtocolException("Unexpected response to set velocity request!");
    }
    return;
  }
...
#endif // MYACTUATOR_RMD_DRIVER__PROTOCOL__RESPONSES__SET_VELOCITY_RESPONSE
