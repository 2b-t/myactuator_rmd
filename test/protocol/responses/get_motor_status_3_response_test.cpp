...
namespace myactuator_rmd_driver {
  namespace test {
    ...
    TEST(GetMotorStatus3ResponseTest, parsing) {
      myactuator_rmd_driver::GetMotorStatus3Response const response {{0x9D, 0x32, 0xC2, 0x0B, 0x10, 0xFA, 0xC0, 0xF9}};
      myactuator_rmd_driver::MotorStatus3 const motor_status {response.getStatus()};
